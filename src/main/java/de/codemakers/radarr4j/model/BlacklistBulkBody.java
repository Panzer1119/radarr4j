...
public class BlacklistBulkBody {
  @SerializedName("ids")
  private List<Integer> ids = new ArrayList<>();

  public BlacklistBulkBody ids(List<Integer> ids) {
    this.ids = ids;
    return this;
  }

  public BlacklistBulkBody addIdsItem(Integer idsItem) {
    this.ids.add(idsItem);
    return this;
  }

   /**
   * Database ids of the blacklist items to delete
   * @return ids
  **/
  @Schema(required = true, description = "Database ids of the blacklist items to delete")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BlacklistBulkBody blacklistBulkBody = (BlacklistBulkBody) o;
    return Objects.equals(this.ids, blacklistBulkBody.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class BlacklistBulkBody {\n");
